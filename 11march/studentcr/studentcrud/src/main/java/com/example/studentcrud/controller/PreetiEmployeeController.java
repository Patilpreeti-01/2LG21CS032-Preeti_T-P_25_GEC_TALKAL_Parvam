...
import com.example.studentcrud.service.PreetiEmployeeService;

@Controller
@RequestMapping("/Preeti")

public class PreetiEmployeeController {

    @Autowired
    private PreetiEmployeeService employeeService;
